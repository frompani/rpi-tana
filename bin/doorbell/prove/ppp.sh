...
print "GPIO port 5 (pin 22) to GND (pin 6) through a ~1k resistor\n"
...
try:
    print "When pressed, you'll see: Rising Edge detected on 5"
    print "When released, you'll see: Falling Edge detected on 5"
